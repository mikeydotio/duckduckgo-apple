...
final class MockOnboardingSuggestionsProvider: OnboardingSuggestionsItemsProviding {
    var list: [ContextualOnboardingListItem] = []
}

final class CapturingOnboardingNavigationDelegate: OnboardingNavigationDelegate {
