...
struct GreenColorPalette: SharedColorPaletteDefinition {
    ...
    static let accentBrandContentPrimary = DynamicColor(lightHex: 0x193926, darkHex: 0x193926)
    static let accentBrandContentSecondary = DynamicColor(lightHex: 0x193926, lightOpacityHex: 0xb2, darkHex: 0x193926, darkOpacityHex: 0xb2)
    static let accentBrandContentTertiary = DynamicColor(lightHex: 0x193926, lightOpacityHex: 0x7f, darkHex: 0x193926, darkOpacityHex: 0x7f)
    static let accentBrandGlowPrimary = DynamicColor(lightHex: 0x85e0ba, lightOpacityHex: 0x33, darkHex: 0x85e0ba, darkOpacityHex: 0x33)
    static let accentBrandGlowSecondary = DynamicColor(lightHex: 0x85e0ba, lightOpacityHex: 0x1e, darkHex: 0x85e0ba, darkOpacityHex: 0x1e)
    static let accentBrandPrimary = DynamicColor(lightHex: 0x99eac8, darkHex: 0x99eac8)
    static let accentBrandSecondary = DynamicColor(lightHex: 0x85e0ba, darkHex: 0x85e0ba)
    static let accentBrandTertiary = DynamicColor(lightHex: 0x6ec7a2, darkHex: 0x6ec7a2)
    static let accentBrandTextPrimary = DynamicColor(lightHex: 0x2c6645, darkHex: 0x2c6645)
    static let accentBrandTextSecondary = DynamicColor(lightHex: 0x235136, darkHex: 0x235136)
    static let accentBrandTextTertiary = DynamicColor(lightHex: 0x193926, darkHex: 0x193926)
    ...
    static let controlsRaisedFillSecondary = DynamicColor(lightHex: 0xf8fcf7, darkHex: 0xe6f2ea, darkOpacityHex: 0x2d)
    static let controlsRaisedFillTertiary = DynamicColor(lightHex: 0xf8fcf7, darkHex: 0xe6f2ea, darkOpacityHex: 0x2d)
    static let controlsSubtleBorderPrimary = DynamicColor(lightHex: 0x288a51, lightOpacityHex: 0x1e, darkHex: 0x88ddba, darkOpacityHex: 0x1e)
    static let controlsSubtleBorderSecondary = DynamicColor(lightHex: 0x288a51, lightOpacityHex: 0x2d, darkHex: 0x88ddba, darkOpacityHex: 0x2d)
    static let controlsSubtleBorderTertiary = DynamicColor(lightHex: 0x288a51, lightOpacityHex: 0x5b, darkHex: 0x88ddba, darkOpacityHex: 0x5b)
    static let controlsSubtleFillPrimary = DynamicColor(lightHex: 0x288a51, lightOpacityHex: 0x07, darkHex: 0x88ddba, darkOpacityHex: 0x1e)
    static let controlsSubtleFillSecondary = DynamicColor(lightHex: 0x288a51, lightOpacityHex: 0x14, darkHex: 0x88ddba, darkOpacityHex: 0x2d)
    static let controlsSubtleFillTertiary = DynamicColor(lightHex: 0x288a51, lightOpacityHex: 0x19, darkHex: 0x88ddba, darkOpacityHex: 0x3d)
    ...
    static let inputActive = DynamicColor(lightHex: 0xf8fcf7, darkHex: 0x2d4d3e)
    static let inputResting = DynamicColor(lightHex: 0xcddfc8, darkHex: 0x2d4d3e)
    ...
    static let surfaceCanvas = DynamicColor(lightHex: 0xedf5ea, darkHex: 0x1c342b)
    static let surfaceContrast = DynamicColor(lightHex: 0x1f9350, lightOpacityHex: 0xf4, darkHex: 0x88ddba, darkOpacityHex: 0xf4)
    ...
    static let toneTintSecondary = DynamicColor(lightHex: 0xf7fcfa, lightOpacityHex: 0x99, darkHex: 0xe6f8f1, darkOpacityHex: 0x1e)
