...
struct GreenColorPalette: SharedColorPaletteDefinition {
    ...
    static let controlsSubtleFillSecondary = DynamicColor(lightHex: 0x288A51, lightOpacity: 0.06, darkHex: 0x88DDBA, darkOpacity: 0.11)
    ...
    static let inputResting = DynamicColor(lightHex: 0xf8fcf7, darkHex: 0x2d4d3e)
