...
struct LatestColorPalette: SharedColorPaletteDefinition {
    static let accentAltContentPrimary = DynamicColor(lightHex: 0x02254d, darkHex: 0xf5fbfe)
    static let accentAltContentSecondary = DynamicColor(lightHex: 0x02254d, lightOpacityHex: 0xb7, darkHex: 0xf5fbfe)
    static let accentAltContentTertiary = DynamicColor(lightHex: 0x02254d, lightOpacityHex: 0x7a, darkHex: 0xffffff)
    static let accentAltGlowPrimary = DynamicColor(lightHex: 0xa1cff7, lightOpacityHex: 0x28, darkHex: 0xa1cff7, darkOpacityHex: 0x1e)
    static let accentAltGlowSecondary = DynamicColor(lightHex: 0xa1cff7, lightOpacityHex: 0x14, darkHex: 0xa1cff7, darkOpacityHex: 0x14)
    static let accentAltPrimary = DynamicColor(lightHex: 0xcbeaff, darkHex: 0x034180)
    static let accentAltSecondary = DynamicColor(lightHex: 0xa1d0f7, darkHex: 0x02254d)
    static let accentAltTertiary = DynamicColor(lightHex: 0x75b6eb, darkHex: 0x01142d)
    static let accentAltTextPrimary = DynamicColor(lightHex: 0x045eb2, darkHex: 0xf5fbfe)
    static let accentAltTextSecondary = DynamicColor(lightHex: 0x034180, darkHex: 0xe6f6ff)
    static let accentAltTextTertiary = DynamicColor(lightHex: 0x02254d, darkHex: 0xcbeaff)
    ...
    static let accentContentPrimary = DynamicColor(lightHex: 0xffffff, darkHex: 0x242323)
    static let accentContentSecondary = DynamicColor(lightHex: 0xffffff, lightOpacityHex: 0xb2, darkHex: 0x111111, darkOpacityHex: 0xb2)
    static let accentContentTertiary = DynamicColor(lightHex: 0xffffff, lightOpacityHex: 0x7f, darkHex: 0x111111, darkOpacityHex: 0x7f)
    ...
    static let accentGlowPrimary = DynamicColor(lightHex: 0x1074cc, lightOpacityHex: 0x33, darkHex: 0x75b6eb, darkOpacityHex: 0x33)
    static let accentGlowSecondary = DynamicColor(lightHex: 0x1074cc, lightOpacityHex: 0x1e, darkHex: 0x75b6eb, darkOpacityHex: 0x1e)
    static let accentPrimary = DynamicColor(lightHex: 0x1074cc, darkHex: 0x75b6eb)
    static let accentQuaternary = DynamicColor(lightHex: 0x02254d, darkHex: 0x045eb2)
    static let accentSecondary = DynamicColor(lightHex: 0x045eb2, darkHex: 0x4397e0)
    static let accentTertiary = DynamicColor(lightHex: 0x034180, darkHex: 0x1074cc)
    static let accentTextPrimary = DynamicColor(lightHex: 0x1074cc, darkHex: 0x75b6eb)
    static let accentTextSecondary = DynamicColor(lightHex: 0x045eb2, darkHex: 0x4397e0)
    static let accentTextTertiary = DynamicColor(lightHex: 0x034180, darkHex: 0x1074cc)
    ...
    static let containerBorderTertiary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x1e, darkHex: 0xffffff, darkOpacityHex: 0x2d)
    static let containerFillPrimary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x05, darkHex: 0xffffff, darkOpacityHex: 0x02)
    ...
    static let containerFillTertiary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x0a, darkHex: 0xffffff, darkOpacityHex: 0x16)
    ...
    static let controlsFillPrimary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x0f, darkHex: 0xffffff, darkOpacityHex: 0x0a)
    static let controlsFillSecondary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x16, darkHex: 0xffffff, darkOpacityHex: 0x0f)
    static let controlsFillTertiary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x1e, darkHex: 0xffffff, darkOpacityHex: 0x14)
    ...
    static let controlsRaisedFillSecondary = DynamicColor(lightHex: 0xffffff, darkHex: 0xffffff, darkOpacityHex: 0x2d)
    static let controlsRaisedFillTertiary = DynamicColor(lightHex: 0xffffff, darkHex: 0xffffff, darkOpacityHex: 0x2d)
    static let controlsSubtleBorderPrimary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x1e, darkHex: 0xffffff, darkOpacityHex: 0x1e)
    static let controlsSubtleBorderSecondary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x2d, darkHex: 0xffffff, darkOpacityHex: 0x2d)
    static let controlsSubtleBorderTertiary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x5b, darkHex: 0xffffff, darkOpacityHex: 0x5b)
    static let controlsSubtleFillPrimary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x05, darkHex: 0xffffff, darkOpacityHex: 0x07)
    static let controlsSubtleFillSecondary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x0c, darkHex: 0xffffff, darkOpacityHex: 0x0f)
    static let controlsSubtleFillTertiary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x14, darkHex: 0xffffff, darkOpacityHex: 0x1e)
    ...
    static let destructiveGlowPrimary = DynamicColor(lightHex: 0xe5244b, lightOpacityHex: 0x33, darkHex: 0xee6d87, darkOpacityHex: 0x33)
    static let destructiveGlowSecondary = DynamicColor(lightHex: 0xe5244b, lightOpacityHex: 0x33, darkHex: 0xee6d87, darkOpacityHex: 0x1e)
    static let destructivePrimary = DynamicColor(lightHex: 0xd83544, darkHex: 0xe44d55)
    static let destructiveSecondary = DynamicColor(lightHex: 0xca2b3d, darkHex: 0xd83544)
    static let destructiveTertiary = DynamicColor(lightHex: 0xa02231, darkHex: 0xca2b3d)
    static let destructiveTextPrimary = DynamicColor(lightHex: 0xca2b3d, darkHex: 0xf06565)
    static let destructiveTextSecondary = DynamicColor(lightHex: 0xa02231, darkHex: 0xe44d55)
    static let destructiveTextTertiary = DynamicColor(lightHex: 0x671421, darkHex: 0xd83544)
    ...
    static let inputActive = DynamicColor(lightHex: 0xffffff, darkHex: 0x3d3d3d)
    static let inputResting = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x0c, darkHex: 0xffffff, darkOpacityHex: 0x14)
    ...
    static let statusYellow = DynamicColor(lightHex: 0xfab341, darkHex: 0xfab341)
    ...
    static let surfacePrimary = DynamicColor(lightHex: 0xf8f8f8, darkHex: 0x212121)
    ...
    static let textPrimary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0xf4, darkHex: 0xffffff)
    static let textSecondary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x99, darkHex: 0xffffff, darkOpacityHex: 0xb2)
    static let textTertiary = DynamicColor(lightHex: 0x000000, lightOpacityHex: 0x5b, darkHex: 0xffffff, darkOpacityHex: 0x66)
