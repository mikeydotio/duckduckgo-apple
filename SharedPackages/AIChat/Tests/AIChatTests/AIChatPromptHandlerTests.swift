...
final class AIChatPromptHandlerTests: XCTestCase {
    ...
    func testSetData() {
        ...
        let testData: AIChatPromptHandler.DataType = .init(platform: "platform", tool: .query(.init(prompt: "Test Prompt", autoSubmit: false, toolChoice: nil, images: nil, modelId: nil, mode: nil)))
