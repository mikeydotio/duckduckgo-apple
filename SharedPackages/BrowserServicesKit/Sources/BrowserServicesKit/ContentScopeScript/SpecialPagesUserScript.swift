...
public final class SpecialPagesUserScript: NSObject, UserScript, UserScriptMessaging {
    ...
    public let broker = UserScriptMessageBroker(context: SpecialPagesUserScript.context, requiresRunInPageContentWorld: true, isMessageHandlerTargetNavigator: true)
