...
public final class ContentScopeUserScript: NSObject, UserScript, UserScriptMessaging, UserScriptWithContentScope {
    ...
    public init(_ privacyConfigManager: PrivacyConfigurationManaging,
        ...
        broker = UserScriptMessageBroker(context: scriptContext.messagingContextName, requiresRunInPageContentWorld: !scriptContext.isIsolated, debug: properties.debug, isMessageHandlerTargetNavigator: true)
