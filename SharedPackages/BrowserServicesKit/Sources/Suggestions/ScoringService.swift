...
struct ScoringService {
    ...
    static func scored(lowercasedQuery: String, queryTokens: [String]?) -> (Bookmark) -> ScoredSuggestion? {
        { bookmark in
    ...
    static func scored(lowercasedQuery: String, queryTokens: [String]?) -> (HistorySuggestion) -> ScoredSuggestion? {
        { historyEntry in
    ...
    static func scored(lowercasedQuery: String, queryTokens: [String]?) -> (InternalPage) -> ScoredSuggestion? {
        { internalPage in
    ...
    static func scored(lowercasedQuery: String, queryTokens: [String]?) -> (BrowserTab) -> ScoredSuggestion? {
        { browserTab in
