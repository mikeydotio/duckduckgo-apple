...
public struct UserText {
    ...
    public static let contextualChatDeleteConfirmationSubtitle = NSLocalizedString("contextual.chat.delete.confirmation.subtitle", value: "You can't undo this action", comment: "Subtitle for the confirmation dialog when deleting a contextual AI chat")
