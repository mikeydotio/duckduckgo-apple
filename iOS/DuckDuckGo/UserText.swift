...
public struct UserText {
    ...
    public static let syncUpdateRequiredDescription = NSLocalizedString("alert.sync-update-required-description", value: "", comment: "Description for Sync error shown when the app version does not support the scanned Sync code")
