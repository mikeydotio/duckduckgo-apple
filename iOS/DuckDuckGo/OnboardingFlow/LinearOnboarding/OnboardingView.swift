...
private extension OnboardingView.BubbleBackedDialogConfiguration {

    init(tailOffset: CGFloat, tailDirection: OnboardingView.BubbleTail.Direction, additionalTopMargin: CGFloat = 0, isVisible: Bool) {
