...
enum UserText {
    ...
    static let deviceSynced = NSLocalizedString("prefrences.sync.device-synced", bundle: Bundle.module, value: "Device synced!", comment: "Sync setup confirmation dialog title")
    ...
    static let syncUpdateRequiredDescription = NSLocalizedString("alert.sync-update-required-description", bundle: Bundle.module, value: "Please update the DuckDuckGo browser and try again.", comment: "Description for Sync error shown when the app version does not support the scanned Sync code")
    ...
    static let syncAlreadyPairedWithAccountTitle = NSLocalizedString("alert.sync-already-paired-with-account-title", bundle: Bundle.module, value: "Already Paired", comment: "Title for Sync error shown when both devices are already paired with the same account")
    static let syncAlreadyPairedWithAccountDescription = NSLocalizedString("alert.sync-already-paired-with-account-description", bundle: Bundle.module, value: "You're already paired with this account on both devices.", comment: "Description for Sync error shown when both devices are already paired with the same account")
    ...
    static let unableToSyncWithAnotherDeviceDescription = NSLocalizedString("alert.unable-to-sync-with-another-device-description", bundle: Bundle.module, value: "Sync failed, please try again later.", comment: "Description for unable to sync with another device error")
    ...
    static let invalidCodeDescription = NSLocalizedString("alert.invalid-code-description", bundle: Bundle.module, value: "This is not a valid Sync code.", comment: "Description for invalid code error")
