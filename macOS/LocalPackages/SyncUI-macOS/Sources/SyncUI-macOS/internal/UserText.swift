...
enum UserText {
    ...
    static let syncUpdateRequiredTitle = NotLocalizedString("alert.sync-update-required-title", bundle: Bundle.module, value: "Update the DuckDuckGo browser and try again.", comment: "Title for Sync error shown when the app version does not support the scanned Sync code")
    static let syncUpdateRequiredDescription = NotLocalizedString("alert.sync-update-required-description", bundle: Bundle.module, value: "This code is not supported in the current app version.", comment: "Description for Sync error shown when the app version does not support the scanned Sync code")
    static let syncUnsupportedThirdPartyRecoveryCodeTitle = NotLocalizedString("alert.sync-code-only-compatible-with-duckai-title", bundle: Bundle.module, value: "Scan this code from Duck.ai Settings.", comment: "Title for Sync error shown when a third-party recovery code can only be used with Duck.ai")
    static let syncUnsupportedThirdPartyRecoveryCodeDescription = NotLocalizedString("alert.sync-code-only-compatible-with-duckai-description", bundle: Bundle.module, value: "In your browser, visit duck.ai, go to Settings, then under “Sync & Backup” select “Turn On” and then “Sync with another device”.", comment: "Description for Sync error shown when a third-party recovery code can only be used with Duck.ai")
    static let syncThirdPartyAccountAlreadyUpgradedDescription = NotLocalizedString("alert.sync-from-another-connected-device-description", bundle: Bundle.module, value: "Please Sync this device from an already-connected DuckDuckGo browser on another device.", comment: "Description for Sync error shown when a third-party account already has a native DuckDuckGo Sync credential")
    static let syncAlreadyPairedWithAccountTitle = NotLocalizedString("alert.sync-already-paired-with-account-title", bundle: Bundle.module, value: "Already Paired", comment: "Title for Sync error shown when both devices are already paired with the same account")
    static let syncAlreadyPairedWithAccountDescription = NotLocalizedString("alert.sync-already-paired-with-account-description", bundle: Bundle.module, value: "You're already paired with this account on both devices.", comment: "Description for Sync error shown when both devices are already paired with the same account")
    static let syncAlreadyPairedWithAccountButton = NotLocalizedString("alert.sync-already-paired-with-account-button", bundle: Bundle.module, value: "Got It", comment: "Button title for Sync error shown when both devices are already paired with the same account")
    static let syncCancelledFromOtherDeviceTitle = NotLocalizedString("alert.sync-cancelled-from-other-device-title", bundle: Bundle.module, value: "Sync canceled from your other device.", comment: "Title for Sync error shown when setup is canceled from the other device")
    static let syncCancelledFromOtherDeviceDescription = NotLocalizedString("alert.sync-cancelled-from-other-device-description", bundle: Bundle.module, value: "Please try again.", comment: "Description for Sync error shown when setup is canceled from the other device")
    static let syncCancelledFromOtherDeviceButton = NotLocalizedString("alert.sync-cancelled-from-other-device-button", bundle: Bundle.module, value: "Got It", comment: "Button title for Sync error shown when setup is canceled from the other device")
