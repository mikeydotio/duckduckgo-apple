...
final class PromoServiceFactoryTests: XCTestCase {
    ...
    func testFactoryCreatesRMFPromosWithCorrectConfiguration() async {
        ...
        XCTAssertTrue(ntpPromo.coexistingPromoIDs.contains("next-steps-cards"), "remote-message-ntp must coexist with next-steps-cards")
        ...
        XCTAssertTrue(tabBarPromo.coexistingPromoIDs.contains("next-steps-cards"), "remote-message-tabbar must coexist with next-steps-cards")
    }
    ...
    func testFactoryCreatesNextStepsPromoWithCorrectConfiguration() {
        ...
        XCTAssertTrue(promo.coexistingPromoIDs.contains("remote-message-tabbar"), "next-steps-cards must coexist with remote-message-tabbar")
