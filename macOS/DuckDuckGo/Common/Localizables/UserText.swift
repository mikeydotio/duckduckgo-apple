...
struct UserText {
    ...
    static let aiChatGlobalEntryPointSectionTitle = NSLocalizedString("duckai.global-entry-point.section.title", value: "Duck.ai global entry point", comment: "Section title for the OS-level Duck.ai entry point setting")
    static let aiChatGlobalEntryPointToggleLabel = NSLocalizedString("duckai.global-entry-point.toggle.label", value: "Enable global Duck.ai shortcut", comment: "Toggle label to enable the OS-level Duck.ai entry point")
    static let aiChatGlobalEntryPointToggleCaption = NSLocalizedString("duckai.global-entry-point.toggle.caption", value: "Adds a Duck.ai icon to the menu bar and the global keyboard shortcut Ctrl+Option+Space to open Duck.ai from any app. DuckDuckGo will start at login. Background activation requires Accessibility permission.", comment: "Caption explaining what the global Duck.ai entry-point toggle does")
    static let aiChatStatusBarOpenItem = NSLocalizedString("duckai.status-bar.open", value: "Open Duck.ai", comment: "Menu item to open Duck.ai from the menu-bar status item")
    static let aiChatStatusBarTooltip = NSLocalizedString("duckai.status-bar.tooltip", value: "Open Duck.ai", comment: "Tooltip on the Duck.ai menu-bar status item")
