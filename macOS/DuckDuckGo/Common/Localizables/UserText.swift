...
struct UserText {
    ...
    static let duckPlayerYouTubeAdBlockingExplanation = NSLocalizedString("duck-player.youtube-ad-blocking.explanation", value: "Duck Player provides a cleaner viewing experience and prevents viewing activity from influencing your YouTube recommendations.", comment: "Duck Player explanation shown in YouTube Ad Blocking settings")
