...
struct UserText {
    ...
    static let aiChatAutomaticallySendPageContentToggle = NSLocalizedString("duckai.automatically-send-page-content.toggle-setting", value: "Auto-attach page content in the sidebar", comment: "Settings option to automatically attach page content to Duck.ai in the sidebar")
