...
struct UserText {
    ...
    static let aiChatImageGenerationButtonTitle = NSLocalizedString("aichat.image-generation-button.title", value: "Create Image", comment: "Title for the image generation toggle button in AI chat omnibar")
    static let aiChatImageGenerationButtonTooltip = NSLocalizedString("aichat.image-generation-button.tooltip", value: "Create Image", comment: "Tooltip for the image generation toggle button in AI chat omnibar")
    static let aiChatImageGenerationPlaceholder = NSLocalizedString("aichat.image-generation.placeholder", value: "Describe the image you want to create", comment: "Placeholder text shown in the Duck.ai input field when image generation mode is active")
