...
struct UserText {
    ...
    static let youTubeAdBlockingAnalyticsOptInAlertTitle = NSLocalizedString("preferences.youtube-ad-blocking.opt-in-alert.title", value: "Help make YouTube Ad Blocking better for everyone", comment: "Title of the alert shown when the user is enabling YouTube ad blocking")
    static let youTubeAdBlockingAnalyticsOptInAlertMessage = NSLocalizedString("preferences.youtube-ad-blocking.opt-in-alert.message", value: "Auto-send anonymous breakage reports to DuckDuckGo when YouTube Ad Block is on.", comment: "Description of the alert shown when the user is enabling YouTube ad blocking")
    static let youTubeAdBlockingAnalyticsOptInAlertConfirmButton = NSLocalizedString("preferences.youtube-ad-blocking.opt-in-alert.confirm", value: "Send Anonymous Reports", comment: "Confirm button label of the alert shown when the user is enabling YouTube ad blocking")
    static let youTubeAdBlockingAnalyticsOptInAlertCancelButton = NSLocalizedString("preferences.youtube-ad-blocking.opt-in-alert.cancel", value: "No Thanks", comment: "Cancel button label of the alert shown when the user is enabling YouTube ad blocking")
