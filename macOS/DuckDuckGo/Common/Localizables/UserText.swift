...
struct UserText {
    ...
    static let aiChatAttachMenuScreenshot = NSLocalizedString("aichat.attach-menu.screenshot", value: "Take Screenshot", comment: "Parent item in the AI chat omnibar add-attachment menu. Its submenu lets the user choose between a drag-to-select region, an entire display, or a specific window.")
    static let aiChatAttachMenuScreenshotSelection = NSLocalizedString("aichat.attach-menu.screenshot.selection", value: "Drag to Select", comment: "First item inside the 'Take Screenshot' submenu. Triggers the drag-to-select region picker (the system overlay with the crosshair cursor). Reads as an action prompt — tells the user what's about to happen.")
    static let aiChatAttachMenuScreenshotSelectScreen = NSLocalizedString("aichat.attach-menu.screenshot.select-screen", value: "Select Screen", comment: "Parent item inside the 'Take Screenshot' submenu. Its sub-submenu lists each connected display the user can capture in one shot.")
    static let aiChatAttachMenuScreenshotSelectWindow = NSLocalizedString("aichat.attach-menu.screenshot.select-window", value: "Select Window", comment: "Parent item inside the 'Take Screenshot' submenu. Its sub-submenu lists each open application window the user can capture in one shot, grouped by app when an app has multiple windows.")
