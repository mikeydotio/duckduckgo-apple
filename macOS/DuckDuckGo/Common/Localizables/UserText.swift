...
struct UserText {
    ...
    static let passwordManagerAlertNoteRequiresDomainTitle = NSLocalizedString("password.manager.alert.note.requires.domain.title", value: "Website or App Required", comment: "Title of alert shown when saving a note-only credential with a blank website field")
    static let passwordManagerAlertNoteRequiresDomainDescription = NSLocalizedString("password.manager.alert.note.requires.domain.description", value: "To save this secure note, enter a website or app name.", comment: "Body text of alert shown when saving a note-only credential with a blank website field")
