...
struct UserText {
    ...
    static let aiChatGlobalEntryPointToggleCaption = NSLocalizedString("duckai.global-entry-point.toggle.caption", value: "Adds a Duck.ai icon to the menu bar and the global keyboard shortcut Ctrl+Option+Space to open Duck.ai from any app.", comment: "Caption explaining what the global Duck.ai entry-point toggle does")
