...
struct UserText {
    ...
    static let aiChatModelPickerTryForFree = NSLocalizedString("aichat.model-picker.try-for-free", value: "Try for free", comment: "Link in the model picker menu that opens the subscription purchase flow, shown to free users")
    static let aiChatModelPickerUpgrade = NSLocalizedString("aichat.model-picker.upgrade", value: "Upgrade", comment: "Link in the model picker menu that opens the subscription upgrade flow, shown to Plus subscribers")
    ...
    static let aiChatSubscriptionUpsellDialogSubscribeButton = NSLocalizedString("aichat.subscription-upsell-dialog.subscribe-button", value: "Subscribe to DuckDuckGo", comment: "Primary button in the subscription upsell dialog that opens the purchase/upgrade flow")
