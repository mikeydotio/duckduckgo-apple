...
3. Update story status as you work: `story move SH-<n> in-progress`
4. Add progress notes: `story comment SH-<n> "what changed and why"`
5. Mark complete: `story move SH-<n> done "summary of what was delivered"`
...
- Before starting a story: `story move SH-<n> in-progress`
